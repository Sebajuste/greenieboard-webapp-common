...
export function PortalSidebar({ menuList = [], showSideBar, closeSideBar }: { menuList?: MenuList, showSideBar: boolean, closeSideBar: () => void }) {
  ...
  const mainSideBarContent = (
    <List sx={{ height: "100%" }}>
      <StyledListItemButton disableRipple>
        <img src="/logo.png" alt="Logo" width={31} />
